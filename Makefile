...
PALS_avalanche: PALS_avalanche.cpp PALS_avalanche_lib.cpp PALS_avalanche_fileTools.cpp PALS_avalanche_fitFunctions.cpp PALS_avalanche_resultsSaver.cpp PALS_avalanche_libTools.cpp
	$(CC) PALS_avalanche.cpp PALS_avalanche_lib.cpp PALS_avalanche_fileTools.cpp PALS_avalanche_fitFunctions.cpp PALS_avalanche_resultsSaver.cpp PALS_avalanche_libTools.cpp -o PALS_avalanche_lite.exe $(CLIBS) -std=c++11
